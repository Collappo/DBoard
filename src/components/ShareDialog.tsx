...
export default function ShareDialog({ elements, onImport, onClose, mode }: ShareDialogProps) {
  ...
  useEffect(() => {
    // Elegant, highly optimized GSAP entry animation
  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl p-6 shadow-2xl border border-gray-200/50 dark:border-gray-800/50 flex flex-col gap-5 text-gray-800 dark:text-gray-200"
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold tracking-tight">
            {mode === 'export' ? 'Udostępnij tablicę' : 'Importuj tablicę'}
          </h2>
        </div>
        ...
        {mode === 'import' && (
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2.5 rounded-xl text-xs transition-colors cursor-pointer flex items-center justify-center gap-1.5"
            >
